...
const data: UserDataType[] = [
    ...
    { name: 'Brendan Flanagan', subteams: ['CNC'], classOf: '2026', major: 'Mechanical/Aerospace Engineering' },
    ...
    { name: 'Daniel de Dios Molina', subteams: [], classOf: '2028', major: '?' },
    { name: 'David Kaplan', subteams: [], classOf: '2028', major: 'Mechanical Engineering' },
    ...
    { name: 'Evan Zhou', subteams: ['Manufacturing'], classOf: '2028', major: '?' },
    { name: 'Finn Barrett', subteams: [], classOf: '2028', major: 'Mechanical Engineering' },
    { name: 'Gabriel Kenji Miyake', subteams: ['Frame'], classOf: '2026', major: 'Mechanical Engineering' },
    ...
    { name: 'John Scherer', subteams: ['Frame'], classOf: '2027', major: 'Mechanical Engineering' },
